...
# %% editable=true slideshow={"slide_type": ""} tags=["remove-output", "hide-input", "active-ipynb"]
# Tlist = [data_T]
...
# %% editable=true slideshow={"slide_type": ""} tags=["active-ipynb", "hide-cell"]
...
# %% editable=true slideshow={"slide_type": ""} tags=["active-ipynb", "hide-input", "remove-output"]
